...
这个文件记录了Kaplay.js项目的所有重要更新和变更历史。

更新日志对开发者和用户都非常重要，它就像是游戏引擎的"成长日记"，记录了每一个版本的新增功能、
修复的问题、破坏性变更等信息。通过这个文件，开发者和用户可以清楚地了解：
...
这个文件遵循"Keep a Changelog"规范格式和语义化版本控制(Semantic Versioning)原则，
确保版本号的变更能准确反映代码变更的性质和影响范围。

对小朋友来说，可以这样理解：
这就像是游戏的"升级记录本"！每次游戏更新，开发者都会在这里写下这次更新添加了什么新玩具(新功能)，
修好了什么坏掉的玩具(修复bug)，或者改变了某些玩具的使用方法(API变更)。
这样玩家就知道每次更新带来了什么新变化，也能更好地适应这些变化！
-->
